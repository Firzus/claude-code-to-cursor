...
export function AuroraShader({ className, intensity = 1 }: AuroraShaderProps) {
  ...
  return (
    ...
    >
      <span
        data-aurora-blob
        className="absolute -top-32 -left-24 size-[42rem] rounded-full bg-aurora-1/55 blur-[80px] dark:bg-aurora-1/40"
      />
      <span
        data-aurora-blob
        className="absolute -top-24 right-0 size-[36rem] rounded-full bg-aurora-2/50 blur-[88px] dark:bg-aurora-2/35"
      />
      <span
        data-aurora-blob
        className="absolute top-12 right-1/4 size-[28rem] rounded-full bg-aurora-3/45 blur-[72px] dark:bg-aurora-3/30"
      />
    </div>
  );
}
