        ...
        <section className="mt-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <FeatureTile
              ...
              description="Any OpenAI-compatible client speaks to Claude. Messages, tools, images, and streaming are rewritten on the fly while the dashboard controls the real Anthropic backend model."
              icon={Radio}
